...
for i = 1, #ships do
    ...
    local license_format = '{"itemName":"shiplicense_' .. ship.ship .. '","shortdescription":"' .. ship.name .. '","description":"' .. ship.description .. '","price":' .. (ship.price or 8500) .. ',"tooltipKind":"namje_shiplicense","rarity":"essential","category":"shipLicense","itemTags":[],"inventoryIcon":"/items/active/namje_shiplicense/namje_shiplicense.png","twoHanded":true,"maxStack":1,"animation":"/items/active/namje_shiplicense/animation.animation","scripts":["/items/active/namje_shiplicense/namje_shiplicense.lua"],"shipType":"' .. ship.ship .. '","builder":"/items/buildscripts/build_shiplicense.lua"}'
