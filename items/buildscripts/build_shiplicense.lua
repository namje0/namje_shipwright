...
function build(directory, config, parameters, level, seed)
    ...
    config.tooltipFields.cargoLabel = ship_config.atelier_stats.cargo_size and "^orange;Ship Cargo Hold Size:^reset; " .. ship_config.atelier_stats.cargo_size or "^orange;Ship Cargo Hold Size:^reset; ^red;N/A^reset;"
